...
I'm a software engineer that specializes in back-end web development. I enjoy working with [**cryptosystems**](https://en.wikipedia.org/wiki/Cryptosystem) and developing applications that support **privacy**, **security**, [**cyber warfare**](https://en.wikipedia.org/wiki/Cyberwarfare), and [**IT operations**](https://www.ibm.com/topics/it-operations).
